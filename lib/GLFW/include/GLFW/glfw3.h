 ...
 *  unless the feature is cical to the application.
 *
 *  @par
 ...
 *  window will thus inhe the one defined in the application's desktop file.
 ...
 *  keys, it is typically the diacic it would add to a character.
 *
 ...
 *  wing.  GLFW tries to acquire it a few times, which is almost always enough.  If it
 ...
 *  wing of the internal base time is not atomic, so it needs to be
