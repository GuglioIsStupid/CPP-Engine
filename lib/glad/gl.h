/**
 * Loader generated by glad 2.0.8 on Mon Nov 18 18:48:27 2024
 *
...
#define GL_CONSERVATIVE_RASTER_DILATE_GRANULAY_NV 0x937B
...
#define GL_COPY_WE_BUFFER 0x8F37
#define GL_COPY_WE_BUFFER_BINDING 0x8F37
...
#define GL_DEBUG_SEVEY_HIGH 0x9146
#define GL_DEBUG_SEVEY_HIGH_AMD 0x9146
#define GL_DEBUG_SEVEY_HIGH_ARB 0x9146
#define GL_DEBUG_SEVEY_LOW 0x9148
#define GL_DEBUG_SEVEY_LOW_AMD 0x9148
#define GL_DEBUG_SEVEY_LOW_ARB 0x9148
#define GL_DEBUG_SEVEY_MEDIUM 0x9147
#define GL_DEBUG_SEVEY_MEDIUM_AMD 0x9147
#define GL_DEBUG_SEVEY_MEDIUM_ARB 0x9147
#define GL_DEBUG_SEVEY_NOTIFICATION 0x826B
...
#define GL_LINE_WIDTH_GRANULAY 0x0B23
...
#define GL_LIST_PRIOY_SGIX 0x8182
...
#define GL_MESH_OUTPUT_PER_PRIMITIVE_GRANULAY_NV 0x9543
#define GL_MESH_OUTPUT_PER_VERTEX_GRANULAY_NV 0x92DF
...
#define GL_MULTISAMPLE_LINE_WIDTH_GRANULAY_ARB 0x9382
...
#define GL_POINT_SIZE_GRANULAY 0x0B13
...
#define GL_POINT_SPE 0x8861
#define GL_POINT_SPE_ARB 0x8861
#define GL_POINT_SPE_COORD_ORIGIN 0x8CA0
#define GL_POINT_SPE_NV 0x8861
#define GL_POINT_SPE_R_MODE_NV 0x8863
...
#define GL_READ_WE 0x88BA
#define GL_READ_WE_ARB 0x88BA
...
#define GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_WE 0x82AE
#define GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_TEST 0x82AD
#define GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_WE 0x82AF
...
#define GL_SMOOTH_LINE_WIDTH_GRANULAY 0x0B23
#define GL_SMOOTH_LINE_WIDTH_RANGE 0x0B22
#define GL_SMOOTH_POINT_SIZE_GRANULAY 0x0B13
...
#define GL_SPE_AXIAL_SGIX 0x814C
#define GL_SPE_AXIS_SGIX 0x814A
#define GL_SPE_EYE_ALIGNED_SGIX 0x814E
#define GL_SPE_MODE_SGIX 0x8149
#define GL_SPE_OBJECT_ALIGNED_SGIX 0x814D
#define GL_SPE_SGIX 0x8148
#define GL_SPE_TRANSLATION_SGIX 0x814B
...
#define GL_STENCIL_BACK_WEMASK 0x8CA5
...
#define GL_STENCIL_WEMASK 0x0B98
...
#define GL_SUBGROUP_FEATURE_AHMETIC_BIT_KHR 0x00000004
...
#define GL_TEXTURE_COLOR_WEMASK_SGIS 0x81EF
...
#define GL_TEXTURE_PRIOY 0x8066
#define GL_TEXTURE_PRIOY_EXT 0x8066
...
#define GL_TRANSFORM_FEEDBACK_PRIMITIVES_WTEN 0x8C88
#define GL_TRANSFORM_FEEDBACK_PRIMITIVES_WTEN_EXT 0x8C88
#define GL_TRANSFORM_FEEDBACK_PRIMITIVES_WTEN_NV 0x8C88
...
#define GL_WE_DISCARD_NV 0x88BE
#define GL_WE_ONLY 0x88B9
#define GL_WE_ONLY_ARB 0x88B9
#define GL_WE_PIXEL_DATA_RANGE_LENGTH_NV 0x887A
#define GL_WE_PIXEL_DATA_RANGE_NV 0x8878
#define GL_WE_PIXEL_DATA_RANGE_POINTER_NV 0x887C
...
struct _cl_context;
struct _cl_event;
typedef void (GLAD_API_PTR *GLDEBUGPROC)(GLenum source,GLenum type,GLuint id,GLenum sevey,GLsizei length,const GLchar *message,const void *userParam);
typedef void (GLAD_API_PTR *GLDEBUGPROCARB)(GLenum source,GLenum type,GLuint id,GLenum sevey,GLsizei length,const GLchar *message,const void *userParam);
typedef void (GLAD_API_PTR *GLDEBUGPROCKHR)(GLenum source,GLenum type,GLuint id,GLenum sevey,GLsizei length,const GLchar *message,const void *userParam);
typedef void (GLAD_API_PTR *GLDEBUGPROCAMD)(GLuint id,GLenum category,GLenum sevey,GLsizei length,const GLchar *message,void *userParam);
...
#define GL_ARB_point_spe 1
GLAD_API_CALL int GLAD_GL_ARB_point_spe;
...
#define GL_NV_point_spe 1
GLAD_API_CALL int GLAD_GL_NV_point_spe;
...
#define GL_SGIX_list_prioy 1
GLAD_API_CALL int GLAD_GL_SGIX_list_prioy;
...
#define GL_SGIX_spe 1
GLAD_API_CALL int GLAD_GL_SGIX_spe;
...
typedef GLuint (GLAD_API_PTR *PFNGLASYNCCOPYBUFFERSUBDATANVXPROC)(GLsizei waitSemaphoreCount, const GLuint * waitSemaphoreArray, const GLuint64 * fenceValueArray, GLuint readGpu, GLbitfield weGpuMask, GLuint readBuffer, GLuint weBuffer, GLintptr readOffset, GLintptr weOffset, GLsizeiptr size, GLsizei signalSemaphoreCount, const GLuint * signalSemaphoreArray, const GLuint64 * signalValueArray);
...
typedef void (GLAD_API_PTR *PFNGLCOPYBUFFERSUBDATAPROC)(GLenum readTarget, GLenum weTarget, GLintptr readOffset, GLintptr weOffset, GLsizeiptr size);
...
typedef void (GLAD_API_PTR *PFNGLCOPYNAMEDBUFFERSUBDATAPROC)(GLuint readBuffer, GLuint weBuffer, GLintptr readOffset, GLintptr weOffset, GLsizeiptr size);
...
typedef void (GLAD_API_PTR *PFNGLDEBUGMESSAGECONTROLPROC)(GLenum source, GLenum type, GLenum sevey, GLsizei count, const GLuint * ids, GLboolean enabled);
typedef void (GLAD_API_PTR *PFNGLDEBUGMESSAGECONTROLARBPROC)(GLenum source, GLenum type, GLenum sevey, GLsizei count, const GLuint * ids, GLboolean enabled);
typedef void (GLAD_API_PTR *PFNGLDEBUGMESSAGEENABLEAMDPROC)(GLenum category, GLenum sevey, GLsizei count, const GLuint * ids, GLboolean enabled);
typedef void (GLAD_API_PTR *PFNGLDEBUGMESSAGEINSERTPROC)(GLenum source, GLenum type, GLuint id, GLenum sevey, GLsizei length, const GLchar * buf);
typedef void (GLAD_API_PTR *PFNGLDEBUGMESSAGEINSERTAMDPROC)(GLenum category, GLenum sevey, GLuint id, GLsizei length, const GLchar * buf);
typedef void (GLAD_API_PTR *PFNGLDEBUGMESSAGEINSERTARBPROC)(GLenum source, GLenum type, GLuint id, GLenum sevey, GLsizei length, const GLchar * buf);
...
typedef GLuint (GLAD_API_PTR *PFNGLGETDEBUGMESSAGELOGPROC)(GLuint count, GLsizei bufSize, GLenum * sources, GLenum * types, GLuint * ids, GLenum * seveies, GLsizei * lengths, GLchar * messageLog);
typedef GLuint (GLAD_API_PTR *PFNGLGETDEBUGMESSAGELOGAMDPROC)(GLuint count, GLsizei bufSize, GLenum * categories, GLenum * seveies, GLuint * ids, GLsizei * lengths, GLchar * message);
typedef GLuint (GLAD_API_PTR *PFNGLGETDEBUGMESSAGELOGARBPROC)(GLuint count, GLsizei bufSize, GLenum * sources, GLenum * types, GLuint * ids, GLenum * seveies, GLsizei * lengths, GLchar * messageLog);
...
typedef void (GLAD_API_PTR *PFNGLGETPERFMONITORCOUNTERDATAAMDPROC)(GLuint monitor, GLenum pname, GLsizei dataSize, GLuint * data, GLint * bytesWten);
...
typedef void (GLAD_API_PTR *PFNGLGETPERFQUERYDATAINTELPROC)(GLuint queryHandle, GLuint flags, GLsizei dataSize, void * data, GLuint * bytesWten);
...
typedef void (GLAD_API_PTR *PFNGLMULTICASTCOPYBUFFERSUBDATANVPROC)(GLuint readGpu, GLbitfield weGpuMask, GLuint readBuffer, GLuint weBuffer, GLintptr readOffset, GLintptr weOffset, GLsizeiptr size);
...
typedef void (GLAD_API_PTR *PFNGLNAMEDCOPYBUFFERSUBDATAEXTPROC)(GLuint readBuffer, GLuint weBuffer, GLintptr readOffset, GLintptr weOffset, GLsizeiptr size);
...
typedef void (GLAD_API_PTR *PFNGLPRIOIZETEXTURESPROC)(GLsizei n, const GLuint * textures, const GLfloat * prioies);
typedef void (GLAD_API_PTR *PFNGLPRIOIZETEXTURESEXTPROC)(GLsizei n, const GLuint * textures, const GLclampf * prioies);
typedef void (GLAD_API_PTR *PFNGLPRIOIZETEXTURESXOESPROC)(GLsizei n, const GLuint * textures, const GLfixed * prioies);
...
typedef void (GLAD_API_PTR *PFNGLSPEPARAMETERFSGIXPROC)(GLenum pname, GLfloat param);
typedef void (GLAD_API_PTR *PFNGLSPEPARAMETERFVSGIXPROC)(GLenum pname, const GLfloat * params);
typedef void (GLAD_API_PTR *PFNGLSPEPARAMETERISGIXPROC)(GLenum pname, GLint param);
typedef void (GLAD_API_PTR *PFNGLSPEPARAMETERIVSGIXPROC)(GLenum pname, const GLint * params);
...
typedef void (GLAD_API_PTR *PFNGLWEMASKEXTPROC)(GLuint res, GLuint in, GLenum outX, GLenum outY, GLenum outZ, GLenum outW);
...
GLAD_API_CALL PFNGLPRIOIZETEXTURESPROC glad_glPrioizeTextures;
#define glPrioizeTextures glad_glPrioizeTextures
GLAD_API_CALL PFNGLPRIOIZETEXTURESEXTPROC glad_glPrioizeTexturesEXT;
#define glPrioizeTexturesEXT glad_glPrioizeTexturesEXT
GLAD_API_CALL PFNGLPRIOIZETEXTURESXOESPROC glad_glPrioizeTexturesxOES;
#define glPrioizeTexturesxOES glad_glPrioizeTexturesxOES
...
GLAD_API_CALL PFNGLSPEPARAMETERFSGIXPROC glad_glSpeParameterfSGIX;
#define glSpeParameterfSGIX glad_glSpeParameterfSGIX
GLAD_API_CALL PFNGLSPEPARAMETERFVSGIXPROC glad_glSpeParameterfvSGIX;
#define glSpeParameterfvSGIX glad_glSpeParameterfvSGIX
GLAD_API_CALL PFNGLSPEPARAMETERISGIXPROC glad_glSpeParameteriSGIX;
#define glSpeParameteriSGIX glad_glSpeParameteriSGIX
GLAD_API_CALL PFNGLSPEPARAMETERIVSGIXPROC glad_glSpeParameterivSGIX;
#define glSpeParameterivSGIX glad_glSpeParameterivSGIX
...
GLAD_API_CALL PFNGLWEMASKEXTPROC glad_glWeMaskEXT;
#define glWeMaskEXT glad_glWeMaskEXT
